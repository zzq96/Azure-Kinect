...
int main1(int argc, char **argv)
{
	...
	boost::shared_ptr<pcl::Grabber> grabber = 
		boost::make_shared<pcl::KinectAzureDKGrabber>(0, K4A_DEPTH_MODE_WFOV_UNBINNED, K4A_IMAGE_FORMAT_COLOR_BGRA32, K4A_COLOR_RESOLUTION_720P);
	...
	while (!viewer->wasStopped()) 
	{
		...
		if (lock.owns_lock() && cloud) 
		{
			...
			{
				if(cnt==0)	pcl::io::savePCDFileASCII("D:/OneDrive/Code/c++/Azure Kinect/a.pcd", *cloud);
